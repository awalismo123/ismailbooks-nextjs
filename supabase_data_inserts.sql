-- PostgreSQL Data Imports (Generated from MySQL dump)
...
SELECT setval(pg_get_serial_sequence('"user_books"', 'id'), COALESCE((SELECT MAX("id") FROM "user_books") + 1, 1), false);
SELECT setval(pg_get_serial_sequence('"user_summaries"', 'id'), COALESCE((SELECT MAX("id") FROM "user_summaries") + 1, 1), false);
